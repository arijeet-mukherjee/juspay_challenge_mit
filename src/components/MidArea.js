...
function MidArea({ area_list, add_list, event_values }) {
  ...
  return (
    < div className = "flex-1 h-full overflow-auto p-3 border-gray-200 bg-gray-200" >
      <div className="flex justify-between">
        <div className="font-bold mb-5 text-center border border-2 rounded text-white bg-red-600 p-2 w-auto">
          Mid Area
        </div>
