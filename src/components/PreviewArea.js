...
function PreviewArea({ character, add_character, set_active }) {
  ...
  return (
    <div
      className = "w-full flex-none h-full overflow-y-auto p-3 border-gray-200 bg-gray-200"
      id="preview_area"
    >
      <div className="flex justify-between mb-10">
        <div className="font-normal mb-5 text-center border border-2 rounded text-white bg-black p-2 w-auto">
          Preview Area
        </div>
        <div>
          <FormControl className={classes.formControl}>
            <InputLabel shrink id="demo-simple-select-placeholder-label-label" className="font-bold">
              Active
            </InputLabel>
            <Select
