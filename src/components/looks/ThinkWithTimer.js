...
const ThinkWithTimer = ({ character, comp_id }) => {
  ...
  return (
    <Paper elevation={3}>
      <div className="rounded text-center bg-gray-700 p-2 my-3">
        ...
        <div
          id={comp_id}
          className = "flex flex-row flex-wrap text-center bg-green-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
